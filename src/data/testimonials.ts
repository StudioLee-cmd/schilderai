...
export const testimonials: ITestimonial[] = [
    {
        ...
        role: 'Schildersbedrijf Van Houten, Utrecht',
        message: 'Sta je net op de steiger een gevel te doen, belt er een klant. Voorheen nam ik niet op, nu pakt de AI het direct op en plant de afspraak in. Ideaal om door te kunnen verven.',
    ...
    },
    {
        ...
        role: 'Willems Schilders, Eindhoven',
        message: 'Geen dubbele afspraken meer en mijn routes zijn veel logischer. Het systeem snapt gewoon hoe een schilder werkt. Scheelt me uren per week.',
        avatar: '/images/testimonials/testimonial-1.jpg',
        stars: 5
    },
    {
    ...
    {
        name: 'Tom Hendriks',
        role: 'Hendriks Schildersbedrijf, Tilburg',
        message: 'Vroeger was ik na het verven nog 2 uur bezig met offertes en mails. Nu doet het systeem het meeste werk. Ik kan eindelijk op tijd bij mijn gezin zijn.',
        avatar: '/images/testimonials/testimonial-1.jpg',
        stars: 4
    },
    {
    ...
    {
        name: 'Kees Molenaar',
        role: 'Molenaar Schilderwerken, Haarlem',
        message: 'Ik ben 57, geen techneut. Maar het hele systeem is zo opgezet dat ik er niks voor hoef te doen. Ze hebben alles voor me ingesteld en het draait. Simpel, effectief.',
        avatar: '/images/testimonials/testimonial-1.jpg',
        stars: 5
    },
];