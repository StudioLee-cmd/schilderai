...
export const metadata: Metadata = {
  ...
  description: `Een Voice AI telefonist voor ${siteDetails.niche?.toLowerCase()} beantwoordt elke oproep, plant afspraken en stuurt samenvattingen via WhatsApp — 24/7 bereikbaar.`,
  openGraph: {
    title: `Voice AI Telefonist voor ${siteDetails.niche} — ${siteDetails.siteName}`,
