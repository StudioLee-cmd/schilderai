...
export const metadata: Metadata = {
  ...
  description: `Gratis professioneel website design voor jouw ${nicheSingular}sbedrijf: live preview binnen 48 uur, SEO-geoptimaliseerd en zonder verplichtingen.`,
  openGraph: {
    title: `Gratis Website Design voor ${niche} | ${siteDetails.siteName}`,
